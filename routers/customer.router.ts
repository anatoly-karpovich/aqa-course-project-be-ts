...
customerRouter.post("/customers", authmiddleware, schemaMiddleware("customerSchema"), customerValidations, CustomerController.create);
...
customerRouter.put("/customers", authmiddleware, schemaMiddleware("customerSchema"), customerById, customerValidations, CustomerController.update);
